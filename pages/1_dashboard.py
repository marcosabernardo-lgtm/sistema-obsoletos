...
with tab4:
    ...
    empresa = base.groupby("Empresa / Filial")["Custo Total"].sum().reset_index()
    ...
    status = base.groupby("Status do Movimento")["Custo Total"].sum().reset_index()
    ...
    conta = base.groupby("Conta")["Custo Total"].sum().reset_index()
